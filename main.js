...
let face = "The front portrait of an object"; /*Between the quotation marks, 
...
let red = "A color that prompts you to pay close attention to"; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "The command center of a lifeform"; //repeat the instructions for the word "brain"

let masculine = "A very manly person"; //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "The process of articulating about something"; //define 'think' in VERB form,
